...
const UpdateProduct = () => {
    ...
    const handleSubmit = (values) => {
        ...
        var Api = Connections.api + Connections.item + '/' + state.id;
    ...
    const formik = useFormik({
        initialValues: {
            main_category_id: state.main_category_id ? state.main_category_id : '',
            sub_category_id: state.sub_category_id ? state.sub_category_id : '',
            brand: state.brand ? state.brand : '',
            unit: state.unit ? state.unit : '',
            sku: state.sku ? state.sku : '',
            oldprice: state.oldprice ? state.oldprice : '',
    ...
    return (
        <Grid container sx={{ minHeight: 200, justifyContent: 'center' }}>
            ...
            >
                <MiniHeader title="Update Item" back={true} sx={{ backgroundColor: theme.palette.primary.dark }} />
                <Grid container>
                            ...
                            <Grid container spacing={1}>
                                ...
                                <Grid item xs={12} sm={6} sx={{ marginTop: 1 }}>
                                    <FormControl
                                        ...
                                        sx={{ ...theme.typography.customInput }}
                                    >
                                        <InputLabel htmlFor="item_oldprice">Item old price</InputLabel>
                                        <OutlinedInput
                                            id="item_old_price"
                                            name="oldprice"
